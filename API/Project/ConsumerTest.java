...
public class ConsumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder){
        ...
        DslPart requestResponseBody = new PactDslJsonBody().
                numberType("id", 1842).
                stringType("firstName", "Ashwani").
                stringType("lastName", "Maddi").
                stringType("email", "ashwani@example.com");
    ...
    public void consumerTest() {
        ...
        reqTest.put("id", 1842);
        reqTest.put("firstName", "Ashwani");
        reqTest.put("lastName", "Maddi");
        reqTest.put("email", "ashwani@example.com");
